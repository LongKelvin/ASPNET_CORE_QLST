...
@Injectable()
export class Group10SuaChuaServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    suaChua_Group10Insert(input: Group10SuaChuaDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/SuaChua_Group10Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSuaChua_Group10Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSuaChua_Group10Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSuaChua_Group10Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    suaChua_Group10Update(input: Group10SuaChuaDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/SuaChua_Group10Update";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSuaChua_Group10Update(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSuaChua_Group10Update(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSuaChua_Group10Update(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    suaChua_Group10Delete(input: Group10SuaChuaDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/SuaChua_Group10Delete";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSuaChua_Group10Delete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSuaChua_Group10Delete(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSuaChua_Group10Delete(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    suaChua_Group10Approve(input: Group10SuaChuaDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/SuaChua_Group10Approve";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSuaChua_Group10Approve(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSuaChua_Group10Approve(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSuaChua_Group10Approve(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    suaChua_Group10Refuse(input: Group10SuaChuaDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/SuaChua_Group10Refuse";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSuaChua_Group10Refuse(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSuaChua_Group10Refuse(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSuaChua_Group10Refuse(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    suaChua_Group10Search(input: Group10SuaChuaDto | null | undefined): Observable<Group10SuaChuaDto[]> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/SuaChua_Group10Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSuaChua_Group10Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSuaChua_Group10Search(<any>response_);
                } catch (e) {
                    return <Observable<Group10SuaChuaDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group10SuaChuaDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processSuaChua_Group10Search(response: HttpResponseBase): Observable<Group10SuaChuaDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group10SuaChuaDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group10SuaChuaDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    suaChua_Group10SearchById(input: Group10SuaChuaDto | null | undefined): Observable<Group10SuaChuaDto> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/SuaChua_Group10SearchById";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSuaChua_Group10SearchById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSuaChua_Group10SearchById(<any>response_);
                } catch (e) {
                    return <Observable<Group10SuaChuaDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSuaChua_Group10SearchById(response: HttpResponseBase): Observable<Group10SuaChuaDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Group10SuaChuaDto.fromJS(resultData200) : new Group10SuaChuaDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    xe_Group10GetAllXeCoBienSo(): Observable<Group10XeDto[]> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/Xe_Group10GetAllXeCoBienSo";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXe_Group10GetAllXeCoBienSo(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXe_Group10GetAllXeCoBienSo(<any>response_);
                } catch (e) {
                    return <Observable<Group10XeDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group10XeDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processXe_Group10GetAllXeCoBienSo(response: HttpResponseBase): Observable<Group10XeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group10XeDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group10XeDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    taiXe_Group10GetTaiXeByUsername(input: Group10TaiXeDto | null | undefined): Observable<Group10TaiXeDto> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/TaiXe_Group10GetTaiXeByUsername";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTaiXe_Group10GetTaiXeByUsername(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTaiXe_Group10GetTaiXeByUsername(<any>response_);
                } catch (e) {
                    return <Observable<Group10TaiXeDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group10TaiXeDto>><any>_observableThrow(response_);
        }));
    }

    protected processTaiXe_Group10GetTaiXeByUsername(response: HttpResponseBase): Observable<Group10TaiXeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Group10TaiXeDto.fromJS(resultData200) : new Group10TaiXeDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<Group10TaiXeDto>(<any>null);
    }

    /**
     * @return Success
     */
    xe_Group10GetAllTaiXe(): Observable<Group10TaiXeDto[]> {
        let url_ = this.baseUrl + "/api/Group10SuaChua/Xe_Group10GetAllTaiXe";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processXe_Group10GetAllTaiXe(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processXe_Group10GetAllTaiXe(<any>response_);
                } catch (e) {
                    return <Observable<Group10TaiXeDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processXe_Group10GetAllTaiXe(response: HttpResponseBase): Observable<Group10TaiXeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group10TaiXeDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
...
@Injectable()
export class Group8DeXuatServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    test(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group8DeXuat/test";
        url_ = url_.replace(/[?&]$/, "");
    ...
    /**
     * @ma (optional) 
     * @deXuat_MaLoaiXe (optional) 
     * @deXuat_TenXe (optional) 
     * @deXuat_Mau (optional) 
     * @deXuat_MucDich (optional) 
     * @deXuat_LyDo (optional) 
     * @deXuat_TrangThai (optional) 
     * @deXuat_NguoiTao (optional) 
     * @deXuat_NgayTao (optional) 
     * @deXuat_MaBangGia (optional) 
     * @deXuat_SoLuong (optional) 
     * @return Success
     */
    dEXUAT_Group8Edit(ma: number | null | undefined, deXuat_MaLoaiXe: number | null | undefined, deXuat_TenXe: string | null | undefined, deXuat_Mau: string | null | undefined, deXuat_MucDich: string | null | undefined, deXuat_LyDo: string | null | undefined, deXuat_TrangThai: string | null | undefined, deXuat_NguoiTao: string | null | undefined, deXuat_NgayTao: moment.Moment | null | undefined, deXuat_MaBangGia: number | null | undefined, deXuat_SoLuong: number | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group8DeXuat/DEXUAT_Group8Edit?";
        if (ma !== undefined)
            url_ += "Ma=" + encodeURIComponent("" + ma) + "&"; 
        if (deXuat_MaLoaiXe !== undefined)
            url_ += "DeXuat_MaLoaiXe=" + encodeURIComponent("" + deXuat_MaLoaiXe) + "&"; 
        if (deXuat_TenXe !== undefined)
            url_ += "DeXuat_TenXe=" + encodeURIComponent("" + deXuat_TenXe) + "&"; 
        if (deXuat_Mau !== undefined)
            url_ += "DeXuat_Mau=" + encodeURIComponent("" + deXuat_Mau) + "&"; 
        if (deXuat_MucDich !== undefined)
            url_ += "DeXuat_MucDich=" + encodeURIComponent("" + deXuat_MucDich) + "&"; 
        if (deXuat_LyDo !== undefined)
            url_ += "DeXuat_LyDo=" + encodeURIComponent("" + deXuat_LyDo) + "&"; 
        if (deXuat_TrangThai !== undefined)
            url_ += "DeXuat_TrangThai=" + encodeURIComponent("" + deXuat_TrangThai) + "&"; 
        if (deXuat_NguoiTao !== undefined)
            url_ += "DeXuat_NguoiTao=" + encodeURIComponent("" + deXuat_NguoiTao) + "&"; 
        if (deXuat_NgayTao !== undefined)
            url_ += "DeXuat_NgayTao=" + encodeURIComponent(deXuat_NgayTao ? "" + deXuat_NgayTao.toJSON() : "") + "&"; 
        if (deXuat_MaBangGia !== undefined)
            url_ += "DeXuat_MaBangGia=" + encodeURIComponent("" + deXuat_MaBangGia) + "&"; 
        if (deXuat_SoLuong !== undefined)
            url_ += "DeXuat_SoLuong=" + encodeURIComponent("" + deXuat_SoLuong) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDEXUAT_Group8Edit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDEXUAT_Group8Edit(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDEXUAT_Group8Edit(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    dEXUAT_Group8Delete(ma: number | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group8DeXuat/DEXUAT_Group8Delete?";
        if (ma !== undefined)
            url_ += "ma=" + encodeURIComponent("" + ma) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDEXUAT_Group8Delete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDEXUAT_Group8Delete(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDEXUAT_Group8Delete(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class Group9BaoTriServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    group9BaoTri_Insert(input: Group9BaoTriDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/Group9BaoTri_Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup9BaoTri_Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup9BaoTri_Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup9BaoTri_Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    group9BaoTri_Delete(id: number | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/Group9BaoTri_Delete?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup9BaoTri_Delete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup9BaoTri_Delete(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup9BaoTri_Delete(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    group9BaoTri_Update(input: Group9BaoTriDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/Group9BaoTri_Update";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup9BaoTri_Update(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup9BaoTri_Update(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup9BaoTri_Update(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    group9BaoTri_Search(input: Group9BaoTriDto | null | undefined): Observable<Group9BaoTriDto[]> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/Group9BaoTri_Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup9BaoTri_Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup9BaoTri_Search(<any>response_);
                } catch (e) {
                    return <Observable<Group9BaoTriDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Group9BaoTriDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGroup9BaoTri_Search(response: HttpResponseBase): Observable<Group9BaoTriDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(Group9BaoTriDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<Group9BaoTriDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    group9BaoTri_ById(id: number | null | undefined): Observable<Group9BaoTriDto> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/Group9BaoTri_ById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup9BaoTri_ById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup9BaoTri_ById(<any>response_);
                } catch (e) {
                    return <Observable<Group9BaoTriDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup9BaoTri_ById(response: HttpResponseBase): Observable<Group9BaoTriDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Group9BaoTriDto.fromJS(resultData200) : new Group9BaoTriDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    group9BaoTri_ListMaXe(): Observable<number[]> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/Group9BaoTri_ListMaXe";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup9BaoTri_ListMaXe(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup9BaoTri_ListMaXe(<any>response_);
                } catch (e) {
                    return <Observable<number[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup9BaoTri_ListMaXe(response: HttpResponseBase): Observable<number[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    group9BaoTri_ListMaTaiXe(): Observable<number[]> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/Group9BaoTri_ListMaTaiXe";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGroup9BaoTri_ListMaTaiXe(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGroup9BaoTri_ListMaTaiXe(<any>response_);
                } catch (e) {
                    return <Observable<number[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGroup9BaoTri_ListMaTaiXe(response: HttpResponseBase): Observable<number[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class Group10SuaChuaDto implements IGroup10SuaChuaDto {
    ma!: number | undefined;
    suaChua_MaXe!: number | undefined;
    suaChua_BienSo!: string | undefined;
    suaChua_MaTaiXe!: number | undefined;
    suaChua_TenTaiXe!: string | undefined;
    suaChua_LyDo!: string | undefined;
    suaChua_ThanhTien!: number | undefined;
    suaChua_NgayTao!: moment.Moment | undefined;
    suaChua_NguoiTao!: string | undefined;
    suaChua_TrangThai!: string | undefined;
    suaChua_TrangThaiDuyet!: string | undefined;
    suaChua_NgayDuyet!: moment.Moment | undefined;
    suaChua_NguoiDuyet!: string | undefined;
    suaChua_TrangThaiSuaChua!: string | undefined;

    constructor(data?: IGroup10SuaChuaDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.ma = data["ma"];
            this.suaChua_MaXe = data["suaChua_MaXe"];
            this.suaChua_BienSo = data["suaChua_BienSo"];
            this.suaChua_MaTaiXe = data["suaChua_MaTaiXe"];
            this.suaChua_TenTaiXe = data["suaChua_TenTaiXe"];
            this.suaChua_LyDo = data["suaChua_LyDo"];
            this.suaChua_ThanhTien = data["suaChua_ThanhTien"];
            this.suaChua_NgayTao = data["suaChua_NgayTao"] ? moment(data["suaChua_NgayTao"].toString()) : <any>undefined;
            this.suaChua_NguoiTao = data["suaChua_NguoiTao"];
            this.suaChua_TrangThai = data["suaChua_TrangThai"];
            this.suaChua_TrangThaiDuyet = data["suaChua_TrangThaiDuyet"];
            this.suaChua_NgayDuyet = data["suaChua_NgayDuyet"] ? moment(data["suaChua_NgayDuyet"].toString()) : <any>undefined;
            this.suaChua_NguoiDuyet = data["suaChua_NguoiDuyet"];
            this.suaChua_TrangThaiSuaChua = data["suaChua_TrangThaiSuaChua"];
        }
    }

    static fromJS(data: any): Group10SuaChuaDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group10SuaChuaDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["ma"] = this.ma;
        data["suaChua_MaXe"] = this.suaChua_MaXe;
        data["suaChua_BienSo"] = this.suaChua_BienSo;
        data["suaChua_MaTaiXe"] = this.suaChua_MaTaiXe;
        data["suaChua_TenTaiXe"] = this.suaChua_TenTaiXe;
        data["suaChua_LyDo"] = this.suaChua_LyDo;
        data["suaChua_ThanhTien"] = this.suaChua_ThanhTien;
        data["suaChua_NgayTao"] = this.suaChua_NgayTao ? this.suaChua_NgayTao.toISOString() : <any>undefined;
        data["suaChua_NguoiTao"] = this.suaChua_NguoiTao;
        data["suaChua_TrangThai"] = this.suaChua_TrangThai;
        data["suaChua_TrangThaiDuyet"] = this.suaChua_TrangThaiDuyet;
        data["suaChua_NgayDuyet"] = this.suaChua_NgayDuyet ? this.suaChua_NgayDuyet.toISOString() : <any>undefined;
        data["suaChua_NguoiDuyet"] = this.suaChua_NguoiDuyet;
        data["suaChua_TrangThaiSuaChua"] = this.suaChua_TrangThaiSuaChua;
        return data; 
    }
}

export interface IGroup10SuaChuaDto {
    ma: number | undefined;
    suaChua_MaXe: number | undefined;
    suaChua_BienSo: string | undefined;
    suaChua_MaTaiXe: number | undefined;
...
export class Group10TaiXeDto implements IGroup10TaiXeDto {
    ma!: number | undefined;
    taiXe_HoTen!: string | undefined;
    taiXe_TenNguoiDung!: string | undefined;

    constructor(data?: IGroup10TaiXeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Group10TaiXeDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group10TaiXeDto();
        result.init(data);
        return result;
    }
...
export interface IGroup10TaiXeDto {
    ma: number | undefined;
    taiXe_HoTen: string | undefined;
    taiXe_TenNguoiDung: string | undefined;
}
...
export class Group9BaoTriDto implements IGroup9BaoTriDto {
    ...
    baoTri_TinhTrangBaoTri!: string | undefined;
    baoTri_MaXe!: number | undefined;
    ...
    constructor(data?: IGroup9BaoTriDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.baoTri_TinhTrangBaoTri = data["baoTri_TinhTrangBaoTri"];
            this.baoTri_MaXe = data["baoTri_MaXe"];
    ...
    static fromJS(data: any): Group9BaoTriDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group9BaoTriDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["baoTri_TinhTrangBaoTri"] = this.baoTri_TinhTrangBaoTri;
        data["baoTri_MaXe"] = this.baoTri_MaXe;
