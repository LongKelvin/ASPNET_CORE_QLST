...
export class Group9BaoTriServiceProxy {
     ...
     * @return Success
     */
    bAOTRI_Group9Insert(input: Group9BaoTriDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/BAOTRI_Group9Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBAOTRI_Group9Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBAOTRI_Group9Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBAOTRI_Group9Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    bAOTRI_Group9Delete(id: number | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/BAOTRI_Group9Delete?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBAOTRI_Group9Delete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBAOTRI_Group9Delete(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBAOTRI_Group9Delete(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    bAOTRI_Group9Update(input: Group9BaoTriDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/BAOTRI_Group9Update";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBAOTRI_Group9Update(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBAOTRI_Group9Update(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBAOTRI_Group9Update(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    bAOTRI_Group9Search(input: Group9BaoTriDto | null | undefined): Observable<Group9BaoTriDto[]> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/BAOTRI_Group9Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBAOTRI_Group9Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBAOTRI_Group9Search(<any>response_);
                } catch (e) {
    ...
    protected processBAOTRI_Group9Search(response: HttpResponseBase): Observable<Group9BaoTriDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    bAOTRI_Group9ById(id: number | null | undefined): Observable<Group9BaoTriDto> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/BAOTRI_Group9ById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBAOTRI_Group9ById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBAOTRI_Group9ById(<any>response_);
                } catch (e) {
                    return <Observable<Group9BaoTriDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBAOTRI_Group9ById(response: HttpResponseBase): Observable<Group9BaoTriDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    bAOTRI_Group9SearchAll(): Observable<Group9BaoTriDto[]> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/BAOTRI_Group9SearchAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBAOTRI_Group9SearchAll(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBAOTRI_Group9SearchAll(<any>response_);
                } catch (e) {
                    return <Observable<Group9BaoTriDto[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBAOTRI_Group9SearchAll(response: HttpResponseBase): Observable<Group9BaoTriDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    bAOTRI_Group9App(id: number | null | undefined, checkerId: string | null | undefined): Observable<{ [key: string] : any; }> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processBAOTRI_Group9App(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processBAOTRI_Group9App(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processBAOTRI_Group9App(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    getCurrentUserName(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group9BaoTri/GetCurrentUserName";
        url_ = url_.replace(/[?&]$/, "");
...
export class Group9HoatDongTaiXeServiceProxy {
     ...
     * @return Success
     */
    hOATDONGTAIXE_Group9Insert(input: Group9HoatDongTaiXeDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9HoatDongTaiXe/HOATDONGTAIXE_Group9Insert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processHOATDONGTAIXE_Group9Insert(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHOATDONGTAIXE_Group9Insert(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processHOATDONGTAIXE_Group9Insert(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    hOATDONGTAIXE_Group9Delete(id: number | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9HoatDongTaiXe/HOATDONGTAIXE_Group9Delete?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processHOATDONGTAIXE_Group9Delete(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHOATDONGTAIXE_Group9Delete(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processHOATDONGTAIXE_Group9Delete(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    hOATDONGTAIXE_Group9Update(input: Group9HoatDongTaiXeDto | null | undefined): Observable<{ [key: string] : any; }> {
        let url_ = this.baseUrl + "/api/Group9HoatDongTaiXe/HOATDONGTAIXE_Group9Update";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processHOATDONGTAIXE_Group9Update(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHOATDONGTAIXE_Group9Update(<any>response_);
                } catch (e) {
                    return <Observable<{ [key: string] : any; }>><any>_observableThrow(e);
                }
            } else
    ...
    protected processHOATDONGTAIXE_Group9Update(response: HttpResponseBase): Observable<{ [key: string] : any; }> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    hOATDONGTAIXE_Group9Search(input: Group9HoatDongTaiXeDto | null | undefined): Observable<Group9HoatDongTaiXeDto[]> {
        let url_ = this.baseUrl + "/api/Group9HoatDongTaiXe/HOATDONGTAIXE_Group9Search";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processHOATDONGTAIXE_Group9Search(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHOATDONGTAIXE_Group9Search(<any>response_);
                } catch (e) {
    ...
    protected processHOATDONGTAIXE_Group9Search(response: HttpResponseBase): Observable<Group9HoatDongTaiXeDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    hOATDONGTAIXE_Group9ById(id: number | null | undefined): Observable<Group9HoatDongTaiXeDto> {
        let url_ = this.baseUrl + "/api/Group9HoatDongTaiXe/HOATDONGTAIXE_Group9ById?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processHOATDONGTAIXE_Group9ById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHOATDONGTAIXE_Group9ById(<any>response_);
                } catch (e) {
                    return <Observable<Group9HoatDongTaiXeDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processHOATDONGTAIXE_Group9ById(response: HttpResponseBase): Observable<Group9HoatDongTaiXeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Group9HoatDongTaiXeDto.fromJS(resultData200) : new Group9HoatDongTaiXeDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    hOATDONGTAIXE_Group9SearchAll(): Observable<Group9HoatDongTaiXeDto[]> {
        let url_ = this.baseUrl + "/api/Group9HoatDongTaiXe/HOATDONGTAIXE_Group9SearchAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processHOATDONGTAIXE_Group9SearchAll(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHOATDONGTAIXE_Group9SearchAll(<any>response_);
                } catch (e) {
                    return <Observable<Group9HoatDongTaiXeDto[]>><any>_observableThrow(e);
                }
            } else
...
export class Group9HoatDongTaiXeDto implements IGroup9HoatDongTaiXeDto {
    ...
    static fromJS(data: any): Group9HoatDongTaiXeDto {
        data = typeof data === 'object' ? data : {};
        let result = new Group9HoatDongTaiXeDto();
        result.init(data);
        return result;
    }
